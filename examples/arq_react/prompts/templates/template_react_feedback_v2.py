...
Prefer experiments that reduce the most important unresolved uncertainty about which option (A, B, C, D, or E) is the best.
...
- Evaluate all five solutions (or a subset of the most promising ones) on a single train/validation split.
